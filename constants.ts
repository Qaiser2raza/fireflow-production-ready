...
export const INITIAL_SECTIONS: Section[] = [
  { id: 'SEC-1', name: 'Main Hall', prefix: 'MH', totalCapacity: 50, isFamilyOnly: false },
  { id: 'SEC-2', name: 'Family Hall', prefix: 'FH', totalCapacity: 30, isFamilyOnly: true },
  { id: 'SEC-3', name: 'Patio', prefix: 'P', totalCapacity: 40, isFamilyOnly: false },
];

export const INITIAL_SERVERS: Server[] = [
  { id: 'S-TEMP-1', name: 'Staff Member 1', role: 'WAITER', pin: '1111', activeTables: 0 },
  { id: 'S-TEMP-2', name: 'Staff Member 2', role: 'CASHIER', pin: '2222', activeTables: 0 },
  { 
    id: 'SUPER-ADMIN-1', 
    name: 'System Admin', 
    role: 'SUPER_ADMIN', 
...
export const INITIAL_TABLES: Table[] = [
  { id: 'TB-1', name: 'MH-1', sectionId: 'SEC-1', capacity: 2, status: TableStatus.AVAILABLE, lastStatusChange: new Date() },
  { id: 'TB-2', name: 'MH-2', sectionId: 'SEC-1', capacity: 4, status: TableStatus.AVAILABLE, lastStatusChange: new Date() },
  { id: 'TB-3', name: 'MH-3', sectionId: 'SEC-1', capacity: 6, status: TableStatus.AVAILABLE, lastStatusChange: new Date() },
  { id: 'TB-4', name: 'FH-1', sectionId: 'SEC-2', capacity: 6, status: TableStatus.AVAILABLE, lastStatusChange: new Date() },
];
