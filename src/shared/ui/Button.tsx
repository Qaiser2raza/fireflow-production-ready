...
export const Button: React.FC<ButtonProps> = ({
  ...
  className = '',
  disabled,
  type = 'button', // <--- DEFAULT IS 'button' (Safe)
  ...props
}) => {
  ...
  const variants = {
    primary: 'bg-gold-500 text-slate-950 hover:bg-gold-400 shadow-lg shadow-gold-500/20 active:translate-y-0.5',
    secondary: 'bg-slate-800 text-white hover:bg-slate-700 active:translate-y-0.5',
  ...
  return (
    <button
      type={type} // <--- EXPLICITLY BIND THE TYPE
